(async() => {
    ...
    if (console.log("%c GingerFemboyWare Blooket %c\n	By BenitoDub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://github.com/randomstuff69/blooketcheatsplus", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
            ...
            display: "block"
                ...
                style: {
                    ...
                    overflow: "hidden"
                        ...
                        innerHTML: "Youtube - BenitoDub",
                        onclick: () => window.open("https://www.youtube.com/@BenitoDub", "_blank").focus()
                    }), $ = l("div", {
                        id: "controlButtons",
                        style: {
                            display: "flex",
